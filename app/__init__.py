...
def create_app():
    ...
    app.add_url_rule(rule="/teams/update/<string:team_id>", view_func=views.update_team_page, methods=["GET", "POST"])
    ...
    app.add_url_rule(rule="/batting/delete/<int:record_id>", view_func=views.delete_batting_record, methods=["GET", "POST"])
